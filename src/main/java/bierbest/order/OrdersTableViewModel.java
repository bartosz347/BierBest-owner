...
public class OrdersTableViewModel {
    ...
    public void load(boolean showRejected) {
        ...
        getOrdersTask.setOnSucceeded(ev -> {
            mainScreenView.setTableItems((ObservableList<OrderViewModel>) getOrdersTask.getValue());
            mainScreenView.unlockRefresh();
        });
        getOrdersTask.setOnFailed(event -> mainScreenView.unlockRefresh());
